using MachineLearning.ConsoleApp;
using Microsoft.ML;

Console.WriteLine("=== Welcome to Machine Learning ===");
...
var trainingData = new List<SentimentData>
{
    ...
    new SentimentData { SentimentText = "Pleased with the movie.", Sentiment = true }
};
...
Console.WriteLine($"Text 1: '{sample1.SentimentText}' | Prediction: {prediction1.Prediction} | Probability: {prediction1.Probability}");
...
Console.WriteLine("");
Console.WriteLine("Thank you for using the Machine Learning app.");